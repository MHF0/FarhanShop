...
const YourSaller = lazy(() =>
  import("./pages/FooterPages/partnerWithUs/Saller")
);
const JoinWithUs = lazy(() =>
  import("./pages/FooterPages/partnerWithUs/JoineWithUs")
);
const AdvertiseYourProduct = lazy(() =>
  import("./pages/FooterPages/partnerWithUs/AdvertiseYourProduct")
);
const Jops = lazy(() => import("./pages/FooterPages/knowAboutUs/Jops"));
const cashOnDelvirey = lazy(() =>
  import("./pages/FooterPages/payWithUs/cashOnDelvirey")
);
...
const UserDetaels = lazy(() => import("./pages/user/UserDetails"));
...
const SallerProductCreate = lazy(() =>
  import("./pages/saller/product/SallerProductCreate")
);
const SallerColorCreate = lazy(() =>
  import("./pages/saller/color/ColorCreate")
);
const SallerColorUpdate = lazy(() =>
  import("./pages/saller/color/ColorUpdate")
);
  ...
  return (
    ...
    >
      ...
      <Switch>
        ...
        <Route
          exact
          path="/advertiseYourProduct"
          component={AdvertiseYourProduct}
        />
        ...
        <UserRoute exact path="/user/userdetails" component={UserDetaels} />

        <AdminRoute exact path="/admin/dashboard" component={AdminDashboard} />
        <SallerRoute
          exact
          path="/saller/dashboard"
          component={SallerDashboard}
        />
